...
import numpy as np
import scipy.io
from MODEL_div_l1_original_Fixed_5633 import model # original : no gamma and beta ; with l1 regularization
#######Controler########
SCALE_FACTOR = 2
LAMBDA = 0.25 # total_loss = loss + LAMBDA * loss_tv + L1_regularization
TRAIN_DATA = 'LAPSR_manga'
########################
CHECKPOINT_PATH = "./checkpoints/x%d_div_l1_original_%.2ftvFix5633_ON_%s" % (SCALE_FACTOR, LAMBDA, TRAIN_DATA)
