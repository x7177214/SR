...
EPOCH = 150 # Epoch you want to test
LAMBDA = 0.25
MODEL_NAME = "x%d_div_l1_original_%3.2fgrad_plus_more_manga" % (SCALE_FACTOR, LAMBDA)
    ...
    for folder_path in folder_list:
        ...
        for i in range(len(img_list)):
            ...
            if SAVEIMAGE_OR_DISPLAYPSNR == 0:
                ...
                result.save(SAVE_PATH +'_'+ DATASET + '/%d_%d_%s_%3.2f.bmp' % (i, epoch, 'grad', LAMBDA))
