...
import numpy as np
import scipy.io
from MODEL_no_DN_no_l1 import model # no DN and L1 regularization
#######Controler########
SCALE_FACTOR = 2
LAMBDA = 0.50 # total_loss = loss + LAMBDA * loss_tv@strong_edge
TRAIN_DATA = 'LAPSR_manga_chen_edge' # Gaussian blur dataset with strong edge map
########################
CHECKPOINT_PATH = "./checkpoints/x%d_noDN_noL1_edge_%.2ftv_ON_%s" % (SCALE_FACTOR, LAMBDA, TRAIN_DATA) 
...
if __name__ == '__main__':
    ...
    train_output, weights = shared_model(train_input, train_bic, SCALE_FACTOR, True)
