...
SCALE_FACTOR = 2
########################
CHECKPOINT_PATH = "./checkpoints/x%d_div_l1_original_deeper_plus_manga"%SCALE_FACTOR
TRAIN_DATA_PATH = "../dataset/mat/train/x%d/LAPSR_manga"%SCALE_FACTOR
...
if __name__ == '__main__':
    ...
    # [LOSS] Chabonnier
    loss = tf.reduce_sum(tf.sqrt(tf.square(tf.cast(train_output - train_gt, tf.float32))+tf.square(1e-3)))  # to use sqrt, float32 is needed
