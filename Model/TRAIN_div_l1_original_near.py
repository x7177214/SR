...
import numpy as np
import scipy.io
from MODEL_div_l1_original_Fixed import model # original : no gamma and beta ; with l1 regularization
#######Controler########
SCALE_FACTOR = 2
TRAIN_DATA = 'LAPSR_manga_near'
########################
CHECKPOINT_PATH = "./checkpoints/x%d_div_l1_original_ON_%s" % (SCALE_FACTOR, TRAIN_DATA)
