...
from MODEL_div_l1_original_deeper import model
from Subpixel import sb_test

SCALE_FACTOR = 2
DATASET = "testForValidation_d"
EPOCH = 80 # Epoch you want to test
...
CHECKPOINTS_PATH = "./checkpoints/x%d_div_l1_original_grad_deeper_plus_manga"%SCALE_FACTOR
IMAGE_FORMAT = "*.bmp" #*.jpg or *.bmp
SAVE_PATH = "./result/x%d_div_l1_original_grad_deeper_plus_manga"%SCALE_FACTOR
    ...
    for folder_path in folder_list:
        ...
        for i in range(len(img_list)):
            ...
            if SAVEIMAGE_OR_DISPLAYPSNR == 0:
                ...
                result.save(SAVE_PATH +'_'+ DATASET + '/%d_%d_%s.bmp' % (i, epoch, 'ori_deeper'))
