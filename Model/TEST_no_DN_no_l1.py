...
SCALE_FACTOR = 4
DATASET = "Set5"#"testForValidation" # all "*"

#DATA_PATH = "./data/test/x%d"%SCALE_FACTOR
DATA_PATH = "../dataset/mat/test/x%d"%SCALE_FACTOR

CHECKPOINTS_PATH = "./checkpoints/x%d_no_DN_no_L1_plus_more_manga"%SCALE_FACTOR
PSNR_PATH = "psnr/x%d_no_DN_no_L1_plus_more_manga"%SCALE_FACTOR
