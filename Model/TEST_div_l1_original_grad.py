...
CHECKPOINTS_PATH = "./checkpoints/x%d_div_l1_original_grad_plus_more_manga"%SCALE_FACTOR
PSNR_PATH = "psnr/x%d_div_l1_original_grad_plus_more_manga"%SCALE_FACTOR
