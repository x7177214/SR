...
EPOCH = 105 # Epoch you want to test
...
CHECKPOINTS_PATH = "./checkpoints/x%d_div_l1_original_0.75tv_ON_LAPSR_manga"%SCALE_FACTOR
IMAGE_FORMAT = "*.bmp" #*.jpg or *.bmp
SAVE_PATH = "./result/x%d_div_l1_original_0.75tv_ON_LAPSR_manga"%SCALE_FACTOR
